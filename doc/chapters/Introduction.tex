...
\begin{enumerate}[noitemsep]
    ...
    \item Input impedance near 50~$\Omega$ at each coax feed, compatible with the Molex 732511350 U.FL-compatible connector and the external power divider APS-02-WBM-LP-DF-CC.
